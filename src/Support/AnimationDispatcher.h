...
public:
    ...
    {
        // Window-mode hosts are UI-thread scoped and detach before thread shutdown.
        static thread_local AnimationDispatcher instance;
        return instance;
    }
...
private:
    static constexpr wchar_t kWindowClassName[] = L"DxUi.AnimationDispatcher";
