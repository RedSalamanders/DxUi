...
$dirty = & git -C $DxUiRoot status --porcelain --untracked-files=normal
...
if (@($pin.targets).Count -ne 1 -or $pin.targets[0] -ne 'DxUi') { throw 'The single supported target is DxUi.' }
