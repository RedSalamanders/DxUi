...
{
    const std::filesystem::path sourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.TextStoreACP.cpp";
...
{
    const std::filesystem::path internalHeaderPath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.Internal.h";
    ...
    const std::filesystem::path textStorePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.TextStoreACP.cpp";
    ...
    const std::filesystem::path nativeSourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.NativeTextInput.cpp";
...
[[nodiscard]] POINT GetNativeTextClientPointForCaretIndex(AttachedHostWindow& window, DxUi::TextField& field, size_t caretIndex, const char* context)
{
...
[[nodiscard]] DirectWritePointerProbe CreateDirectWritePointerProbeForTextSpan(DxUi::WindowHost& host,
                                                                               std::wstring_view text,
                                                                               const D2D1_RECT_F& textRect,
                                                                               DxUi::FlowDirection flowDirection,
                                                                               size_t spanStart,
                                                                               size_t spanEnd,
                                                                               const char* context)
{
...
void RequireNativeTextSelection(DxUi::WindowHost& host, DxUi::TextField& field, size_t expectedStart, size_t expectedEnd, const char* context)
{
    ...
    DxUi::NativeTextInputState state{};
...
{
    const std::filesystem::path sourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.NativeTextInput.cpp";
    std::ifstream input(sourcePath);
