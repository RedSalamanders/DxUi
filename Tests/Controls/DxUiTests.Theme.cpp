...
void TestThemeColorsPaletteDerivesDarkControlChrome()
{
    using namespace DxUi;
...
void TestThemeColorsPaletteDerivesLightControlChrome()
{
    using namespace DxUi;
...
void TestThemeColorsPaletteDerivesDarkHighContrastChrome()
{
    using namespace DxUi;
...
void TestListIconColorUsesViewerDerivedSelectionFillChrome()
{
    ...
    const ThemePalette theme   = MakeThemePalette(viewerTheme);
...
void TestThemeColorsAccentPressedUsesBaseThemePolarity()
{
    using namespace DxUi;
...
void RunThemeTests()
{
    ...
    TestThemeColorsAccentPressedUsesBaseThemePolarity();
