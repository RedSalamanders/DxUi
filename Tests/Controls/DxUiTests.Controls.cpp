...
void TestChevronGlyphRenderingIsSharedAcrossComboBoxAndGrid()
{
    ...
    const std::string header = readSource(repoRoot / L"src" / L"Controls" / L"DxUi.h", "DxUi header is readable for chevron glyph contract");
    const std::string controls =
        readSource(repoRoot / L"src" / L"Controls" / L"DxUi.Controls.cpp", "DxUi controls source is readable for chevron glyph contract");
    const std::string combo = readSource(repoRoot / L"src" / L"Controls" / L"DxUi.ComboBox.cpp", "DxUi ComboBox source is readable for chevron glyph contract");
    const std::string grid  = readSource(repoRoot / L"src" / L"Controls" / L"DxUi.Grid.cpp", "DxUi Grid source is readable for chevron glyph contract");
...
{
    const std::filesystem::path sourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.Scrollbar.cpp";
    std::ifstream input(sourcePath);
...
void TestScrollbarTrackPagingUsesSharedPageStepHelper()
{
    ...
    const std::string internalHeader =
        readTextFile(repoRoot / L"src" / L"Controls" / L"DxUi.Internal.h", "DxUi internal header is readable for scrollbar page-step guard");
    const std::string scrollbarSource =
        readTextFile(repoRoot / L"src" / L"Controls" / L"DxUi.Scrollbar.cpp", "Scrollbar source is readable for page-step guard");
    const std::string gridSource = readTextFile(repoRoot / L"src" / L"Controls" / L"DxUi.Grid.cpp", "Grid source is readable for scrollbar page-step guard");
    const std::string treeSource = readTextFile(repoRoot / L"src" / L"Controls" / L"DxUi.Tree.cpp", "Tree source is readable for scrollbar page-step guard");
    const std::string controlsSource =
        readTextFile(repoRoot / L"src" / L"Controls" / L"DxUi.Controls.cpp", "Controls source is readable for scrollbar page-step guard");
    const std::string comboSource =
        readTextFile(repoRoot / L"src" / L"Controls" / L"DxUi.ComboBox.cpp", "ComboBox source is readable for scrollbar page-step guard");
...
{
    const std::filesystem::path repoRoot   = FindRepoRootForDxUiTests();
    const std::filesystem::path sourcePath = repoRoot / L"src" / L"Controls" / L"DxUi.Controls.cpp";
    const std::filesystem::path headerPath = repoRoot / L"src" / L"Controls" / L"DxUi.h";
...
void TestMenuBarCachesItemLayoutRectsAndWidths()
{
    ...
    std::ifstream headerInput(repoRoot / L"src" / L"Controls" / L"DxUi.h");
    Require(headerInput.good(), "DxUi header is readable for MenuBar layout cache guard");
    const std::string header((std::istreambuf_iterator<char>(headerInput)), std::istreambuf_iterator<char>());

    std::ifstream sourceInput(repoRoot / L"src" / L"Controls" / L"DxUi.Controls.cpp");
