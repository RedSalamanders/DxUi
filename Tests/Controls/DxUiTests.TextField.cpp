...
{
    const std::filesystem::path sourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.TextInput.cpp";
...
{
    const std::filesystem::path headerPath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.h";
...
{
    const std::filesystem::path sourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.SingleLineTextEditing.cpp";
    std::ifstream input(sourcePath);
...
void TestTextFieldSingleLineLayoutCacheInvalidatesAndFeedsHotPaths()
{
    ...
    const std::filesystem::path helperPath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.SingleLineTextEditing.cpp";
