...
{
    const std::filesystem::path sourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.Accessibility.cpp";
    ...
    const std::filesystem::path windowHostSourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.WindowHost.cpp";
...
{
    const std::filesystem::path sourcePath = FindRepoRootForDxUiTests() / L"src" / L"Controls" / L"DxUi.Tree.cpp";
    std::ifstream input(sourcePath);
...
void TestAccessibilityTextEditCompositionReadsUseSnapshots()
{
    ...
    const std::filesystem::path sourcePath = repoRoot / L"src" / L"Controls" / L"DxUi.Accessibility.cpp";
    std::ifstream input(sourcePath);
    ...
    const std::filesystem::path nativeInputPath = repoRoot / L"src" / L"Controls" / L"DxUi.NativeTextInput.cpp";
