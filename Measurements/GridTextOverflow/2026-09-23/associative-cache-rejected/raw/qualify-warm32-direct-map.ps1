...
$evidence = 'C:/RedSalamander.Perf/evidence/i26-ui/grid-cache-associative-20260923/warm32-direct-map'
...
& ./build.ps1 -Configuration Release -Platform x64 *> "$evidence/build.log"
